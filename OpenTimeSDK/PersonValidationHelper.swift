...
public class PersonValidationHelper {
    ...
    - returns: APIResponse with message explaining failure reason.
    */
    public static func signInInputsValid(email: String, password: String)->APIResponse
    {
        // Validate email.
    ...
    - returns: APIResponse with message explaining failure reason.
    */
    public static func createUserInputsValid(email: String, phoneNumber: String, firstName: String, lastName: String, password: String, confirmPassword: String)->APIResponse
    {
        // Validate email.
        let validEmail = self._validEmail(email);
        if(validEmail.success == false)
    ...
    private static func _validPhone(phone: String) -> APIResponse {
        
        if(phone == "") {
            return APIResponse(success: false, message: "Phone number cannot be blank");
        }
    ...
    - returns: APIResponse with message explaining failure reason.
    */
    private static func _validEmail(email: String)->APIResponse
    {
        // Verify email isn't blank.
        if(email == "")
        {
            // Return failed result.
            return APIResponse(success: false, message: NSLocalizedString("message_email_cannot_be_blank", comment: ""));
        }
        ...
        {
            // Return failed result.
            return APIResponse(success: false, message: NSLocalizedString("message_invalid_email", comment: ""));
        }
    ...
    - returns: APIResponse with message explaining failure reason.
    */
    private static func _validName(firstName: String, lastName: String)->APIResponse
    {
        ...
        {
            // Return failed result.
            return APIResponse(success: false, message: NSLocalizedString("message_first_name_cannot_be_blank", comment: ""));
        }
        ...
        {
            // Return failed result.
            return APIResponse(success: false, message: NSLocalizedString("message_last_name_cannot_be_blank", comment: ""));
        }
    ...
    - returns: APIResponse with message explaining failure reason.
    */
    private static func _validPassword(password: String, confirmPassword: String)->APIResponse
    {
        ...
        {
            // Return failed result.
            return APIResponse(success: false, message: NSLocalizedString("message_passwords_dont_match", comment: ""));
        }
